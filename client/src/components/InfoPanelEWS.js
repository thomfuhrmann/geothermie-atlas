              ...
              <tbody>
                <tr>
                  <td>
                    {closenessWarning && (
                      <Warning>
                        Achtung: Mindestens ein Punkt liegt näher als fünf Meter zu einem anderen Punkt!
                      </Warning>
                    )}
                  </td>
                </tr>
          ...
          {Object.keys(computationResult).includes('error') && (
            <CollapsibleSection title="Berechnungsergebnisse" open={true}>
              <Table id="calculations-output-table">
                ...
                <tbody>
                  <TableRow>
                    <TableHeader textAlign="center">{computationResult.error}</TableHeader>
                  </TableRow>
                </tbody>
              </Table>
          ...
          {Object.keys(computationResult).length > 1 && (
            <CollapsibleSection title="Berechnungsergebnisse" open={true}>
              <Table id="calculations-input-table">
                ...
                <tbody>
                  <TableRow>
                    <TableHeader textAlign="center">Berechnungsvorgaben</TableHeader>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    <TableHeader textAlign="center">Benutzereingabe</TableHeader>
                  </TableRow>
                  <TableRow>
                    <TableData>Sondenanzahl: {computationResult.points}</TableData>
                  </TableRow>
                  {computationResult.meanBoreholeSpacing > 0 && (
                    <TableRow>
                      <TableData>Durchschnittlicher Sondenabstand: {computationResult.meanBoreholeSpacing} m</TableData>
                    </TableRow>
                  )}

                  <TableRow>
                    <TableData>Sondentiefe: {computationResult.boreDepth} m</TableData>
                  </TableRow>
                  {computationResult.calculationMode === 'user' && (
                    <>
                      <TableRow>
                        <TableData>Jahresbetriebsstunden Heizen: {computationResult.BS_HZ} h</TableData>
                      </TableRow>
                      <TableRow>
                        <TableData>Jahresbetriebsstunden Kühlen: {computationResult.BS_KL} h</TableData>
                      </TableRow>
                      <TableRow>
                        <TableData>Heizleistung Gebäude: {computationResult.P_HZ} kW</TableData>
                      </TableRow>
                      <TableRow>
                        <TableData>Kühlleistung Gebäude: {computationResult.P_KL} kW</TableData>
                      </TableRow>
                    </>
                  )}
                  <TableRow>
                    <TableData>Vorlauftemperatur Heizung: {computationResult.T_radiator} °C</TableData>
                  </TableRow>
                  <TableRow>
                  ...
                  {computationResult.calculationMode === 'norm' && (
                    <>
                      <TableRow>
                        <TableData>Norm-Jahresbetriebsstunden Heizen: {computationResult.BS_HZ_Norm} h</TableData>
                      </TableRow>
                      <TableRow>
                        <TableData>Norm-Jahresbetriebsstunden Kühlen: {computationResult.BS_KL_Norm} h</TableData>
                      </TableRow>
                    </>
                  )}
                      ...
                      <>
                        <TableRow>
                          <td>
                            ...
                            zwischen Heizen und Kühlen betrieben werden. Dadurch beeinflussen sich die Sonden
                            gegenseitig kaum und der Sondenabstand kann auf ungefähr 5 Meter reduziert werden. Dies
                            ermöglicht eine optimale thermische Nutzung des Untergrunds und es können höhere Leistungen
                            erreicht werden. Überlegen Sie eine Verbesserung der Energiebilanz zwischen Heizen und
                            Kühlen!
                          </td>
                        </TableRow>
                      </>
              ...
              <Table id="calculations-output-table">
                <tbody>
                  ...
                  <TableRow>
                    <TableData>= Heizleistung Erdwärmeanlage: {computationResult.heizleistung.toFixed(1)} kW</TableData>
                  </TableRow>
                  <TableRow>
                    <TableData>
                  ...
                  <TableRow>
                    <TableData>= Heizarbeit Erdwärmeanlage: {computationResult.heizarbeit.toFixed(1)} MWh/a</TableData>
                  </TableRow>
                  <TableRow>
                    <TableHeader textAlign="center">
                      Kühlbetrieb mit{' '}
                  ...
                  <TableRow>
                    <TableData>= Kühlarbeit Erdwärmeanlage: {computationResult.kuehlarbeit.toFixed(1)} MWh/a</TableData>
                  </TableRow>
                  {computationResult.cover > 0 && (
                    <TableRow>
                      <TableData>Deckungsgrad gesamt: {computationResult.cover} %</TableData>
                    </TableRow>
                  )}
                  {computationResult.balanced === 0 && (
                    <TableRow>
                      <td>
                        Ihre Energie- und Leistungsvorgaben des Gebäudes für Heizen und Kühlen bewirken eine
                        ausgeglichene Betriebsweise im Erdsondenfeld. Die Auslegung ist optimal für den saisonalen
                        Speicherbetrieb geeignet.
                      </td>
                    </TableRow>
                  )}
                </tbody>
              ...
              <Placeholder></Placeholder>
              <Image src={computationResult.imagehash} alt="Grafik mit Berechnungsergebnissen" ref={image}></Image>
              <Placeholder></Placeholder>
            </CollapsibleSection>
          )}
          {Object.keys(computationResult).length > 1 && computationResult.balanced === 1 && (
            <CollapsibleSection title="Berechnungsergebnisse für den saisonalen Speicherbetrieb" open={true}>
              <Table id="calculations-bal-output-table">
                ...
                <tbody>
                  ...
                  {computationResult.meanBoreholeSpacing > 5 && (
                    <>
                      <TableRow>
                        <td>
                          Hinweis: Im saisonalen Speicherbetrieb kann der Sondenabstand auf ungefähr fünf Meter
                          reduziert werden ohne dass sich die einzelnen Erdwärmesonden nennenswert gegenseitig
                          beeinflussen. Somit kann der Flächenbedarf ohne signifikante Einbußen der Sondenleistung
                          reduziert werden. Versuchen Sie eine Reduktion des Sondenabstands!
                        </td>
                      </TableRow>
                    </>
                  )}
                ...
                <tbody>
                  ...
                  {computationResult.cover > 0 && (
                    <TableRow>
                      <TableData>Deckungsgrad: {computationResult.cover_bal} %</TableData>
                    </TableRow>
                  )}
                  {computationResult.Efactor_user >= 1 ? (
                    <TableRow>
