...
export const initializeCollapsibleEWS = () => {
  ...
  gridSpacingInput.placeholder = "zwischen 5 und 15 m (default=10)";
  ...
  bohrtiefeInput.placeholder = "zwischen 80 und 250 m (default=100)";
  ...
  bsHZInput.min = 0;
  bsHZInput.max = 4379;
  bsHZInput.placeholder = "zwischen 0 und 4379 Stunden";
  ...
  bsKLInput.min = 0;
  bsKLInput.max = 4379;
  bsKLInput.placeholder = "zwischen 0 und 4379 Stunden";
